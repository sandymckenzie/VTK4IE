...
One of the most important prerequisites of this work was seamless stereo
rendering and user interaction, between the rendering native to the base virtual reality toolkit and the rendering embedded in VTK. 
...
in three dimensional space with closer elements occluding farther ones.
